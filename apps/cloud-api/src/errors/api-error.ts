...
export const ApiErrors = {
  ...
  mediaInvalidKey: new ApiError(400, "MEDIA_INVALID_KEY", "media invalid key"),
  mediaNotFound: new ApiError(404, "MEDIA_NOT_FOUND", "media not found"),
  mediaDeleteFailed: new ApiError(500, "MEDIA_DELETE_FAILED", "media delete failed"),
  mediaRateLimited: new ApiError(429, "MEDIA_RATE_LIMITED", "media rate limited"),
  mediaInvalidSource: new ApiError(400, "MEDIA_INVALID_SOURCE", "media invalid source"),
